...
export default async function RemovedPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="pixl-card p-8 w-full max-w-md">
        ...
        <p className="text-sm text-ink/55 mt-3 mb-6">
          If you think this was a mistake, reach out to the Pixl team and they&apos;ll sort
          you out.
        </p>
        <form action="/api/auth/logout" method="post">
          <button className="pixl-btn bg-ink text-white w-full justify-center border-transparent">
            Sign out
          </button>
        </form>
      </div>
